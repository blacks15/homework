...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            //noinspection HtmlUnknownAttribute
            tBtnBrowse = '<div tabindex="500" class="{css}" data-tooltip="tooltip" {status}>{icon} {label}</div>';
            ...
            tActions = '<div class="file-actions">\n' +
                ...
                '<div class="clearfix"></div>';
            //noinspection HtmlUnknownAttribute
            tActionDelete = '<button type="button" class="kv-file-remove {removeClass}" data-tooltip="tooltip" ' +
                'title="{removeTitle}" {dataUrl}{dataKey}>{removeIcon}</button>\n';
            tActionUpload = '<button type="button" class="kv-file-upload {uploadClass}" data-tooltip="tooltip" title="{uploadTitle}">' +
                '{uploadIcon}</button>';
            tActionDownload = '<a class="kv-file-download {downloadClass}" data-tooltip="tooltip" title="{downloadTitle}" ' +
                'href="{downloadUrl}" download="{caption}" target="_blank">{downloadIcon}</a>';
            tActionZoom = '<button type="button" class="kv-file-zoom {zoomClass}" data-tooltip="tooltip" ' +
        ...
        _getZoomButton: function (type) {
            var self = this,
                ...
                params = title + (type === 'close' ? 'data-tooltip="tooltip" data-dismiss="modal" aria-hidden="true"' : '');
            if (type === 'fullscreen' || type === 'borderless' || type === 'toggleheader') {
                params += 'data-tooltip="tooltip" data-toggle="button" aria-pressed="false" autocomplete="off"';
            }
